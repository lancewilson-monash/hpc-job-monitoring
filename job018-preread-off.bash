...
# ########################################
`which relion_refine_mpi` --o Class3D/job018-$LOGDATE/run --i Select/job016/particles.star --ref InitialModel/job017-$LOGDATE/run_it150_class001_symD2.mrc --ini_high 50 --dont_combine_weights_via_disc   --pool 30 --pad 2  --ctf --ctf_corrected_ref --iter 25 --tau2_fudge 4 --particle_diameter 200 --K 4 --flatten_solvent --zero_mask --oversampling 1 --healpix_order 2 --offset_range 5 --offset_step 2 --sym C1 --norm --scale  --j 1--gpu "" 
# ########################################
PID1=$!
#echo $PID1
